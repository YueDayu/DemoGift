...
public class LocationActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		search_btn.setOnClickListener(new View.OnClickListener()
		{
			...
			{
				//TODO
				new LocationDialog(LocationActivity.this).show();
			}
		});
		mMapView = (MapView) findViewById(R.id.bmapView);
		mBaiduMap = mMapView.getMap();
		LatLng point = new LatLng(40.015391, 116.332535);
		BitmapDescriptor bitmap = BitmapDescriptorFactory.fromResource(R.mipmap.demo_map_position_1);
		...
		etTest.setOnTouchListener(new View.OnTouchListener()
		{
			...
			public boolean onTouch(View view, MotionEvent motionEvent)
			{
				...
				{
					if (motionEvent.getX() >= (view.getWidth() - ((EditText) view).getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width()))
					{
						lpw.show();
						return true;
					}
